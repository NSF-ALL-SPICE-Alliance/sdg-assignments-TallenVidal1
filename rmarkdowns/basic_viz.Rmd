...
Interpretation: I notice that the plots are evenly scattered, however most of the plots are lighter shades of blue and closer to the top right of the graph meaning a good amount of the countries are achieving SDG 1, 2, and 7.I notice that the plots that are closer to the lower left side of the graph, are also mostly darker shades of blue meaning that countries lacking in SDG 1 and 2 are also lacking severly in SDG 7.
...
ggplot(sdr_data, aes(x = goal_1_score, fill=regions_used_for_the_sdr)) + 
  geom_histogram(bins=33, color="black")
```
Interpretation: I notice for this histogram, a majority of the regions are closer to the 100 mark compared to the histogram that tracks the progress towards SDG 4 for all regions. Similarly to SDG 4, the Sub-Saharan African region is the region that has the lowest progress rates. According to this graph, it seems like all regions besides the Sub Saharan African region have passed a goal score of 75
